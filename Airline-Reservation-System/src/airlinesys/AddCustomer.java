...
public class AddCustomer extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(male.isSelected()){
          ...
          String sql = "insert into customer(custid, firstname, lastname, adhaar, passport, address, dob, gender,contact)values (?,?,?,?,?,?,?,?,?)";
            ...
            try {
                ...
                pt= conn.prepareStatement("insert into customer(custid, firstname, lastname, adhaar,passport,address,dob,gender,contact) values(?,?,?,?,?,?,?,?,?)");
                pt.setString(1,id);
